...
subplot(3, 2, 3);
imagesc(abs(modulated_input_prop.*mask2));title('Amp moduliert nach fft'); axis image
subplot(3, 2, 4);
imagesc(angle(modulated_input_prop));title('Phase moduliert nach fft'); axis image
subplot(3, 2, 6);
