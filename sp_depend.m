...
bitDepthSLM = 8;            % Bit
superPixel=sp_z;               % Size of one superpixel
m_SLM=800;      % Y-axis
...
r_pinhole_var=r_pinhole-edge_var:step_var:r_pinhole+15;
...
figure;
plot(sp_nums, fidelity_sp); title('Fidelity in Abhänigigkeit von Superpixelzahl');
