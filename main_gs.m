...
gridSize = fix(desired_beam_size * scale_ratio);             % gridsize for modesolver; Wert am:06.04: 50
...
% moduliere beam
modulated_input = 6 * abs(optical_beam) .* exp(1i*gs_mask); % abs richtig???
...
modulated_input_fft = modulated_input_fft(start:stop, start:stop);
