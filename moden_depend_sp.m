...
mode_target=mode;             % which mode should be generated by SLM?
...
fidelity_sp_mode(mode) = max(fidelity_vals)
mode_nums(mode) = mode
end
figure;
plot(mode_nums, fidelity_sp_mode, 'o'); title('Fidelity in Abhänigigkeit von Mode');
