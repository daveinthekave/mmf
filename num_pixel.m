...
gridSize = d_free;             % gridsize for modesolver; Wert am:06.04: 50
...
bitDepthSLM = 8;            % Bit
superPixel=4;               % Size of one superpixel
m_SLM=800;      % Y-axis
...
xo_pinhole=601;yo_pinhole=401;r_pinhole=14;
...
figure;
plot(anz_pixel, fidelity_sp_pixel); title('Fidelity in Abhänigigkeit von Anzahl an Pixeln');
