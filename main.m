...
mode_target=25;             % which mode should be generated by SLM?

% SLM & Superpixel parameters  
bitDepthSLM = 1;            % Bit
superPixel=8;               % Size of one superpixel
m_SLM=800;      % Y-axis
...
mode_target_distribution_superpixel = superpixel_variabel(mode_target_distribution,superPixel,bitDepthSLM,maximum, 8);
...
xo_pinhole=600;yo_pinhole=400;r_pinhole=21;
